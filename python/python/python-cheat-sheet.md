...
The _itertools_ module is a collection of tools intented to be fast and use memory efficiently when handling iterators (like [lists](broken-reference) or [dictionaries](broken-reference)).
