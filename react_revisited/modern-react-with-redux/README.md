...
#### Redux Fundamentals Tutorial[​](https://redux.js.org/introduction/getting-started#redux-fundamentals-tutorial) <a href="#redux-fundamentals-tutorial" id="redux-fundamentals-tutorial"></a>
