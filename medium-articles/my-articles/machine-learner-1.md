...
* \[📰] [Tricks for training PyTorch models to convergence more quickly](https://spell.ml/blog/pytorch-training-tricks-YAnJqBEAACkARhgD)
...
* \[📰] [Scaling Logistic Regression Via Multi-GPU/TPU Training](https://towardsdatascience.com/scaling-logistic-regression-for-multi-gpu-tpu-training-b4898d5049ff)
* \[📰] [Training Neural Nets on Larger Batches: Practical Tips for 1-GPU, Multi-GPU & Distributed setups](https://medium.com/huggingface/training-larger-batches-practical-tips-on-1-gpu-multi-gpu-distributed-setups-ec88c3e51255)
* \[📰] [PyTorch Lightning 0.9 — synced BatchNorm, DataModules and final API!](https://medium.com/pytorch/pytorch-lightning-0-9-synced-batchnorm-datamodules-and-final-api-aae885398a9d)
* \[📰] [PyTorch Lightning: Metrics](https://medium.com/pytorch/pytorch-lightning-metrics-35cb5ab31857)
* \[📰] [PyTorch Multi-GPU Metrics Library and More in PyTorch Lightning 0.8.1](https://medium.com/pytorch/pytorch-multi-gpu-metrics-and-more-in-pytorch-lightning-0-8-1-b7cadd04893e)
...
* \[📰] [PyTorch Lightning V1.2.0- DeepSpeed, Pruning, Quantization, SWA](https://medium.com/pytorch/pytorch-lightning-v1-2-0-43a032ade82b)
...
* \[📰] [Transform your ML-model to Pytorch with Hummingbird](https://www.maartengrootendorst.com/blog/humming/)
...
* \[📰] [Model Parallelism](https://huggingface.co/transformers/master/parallelism.html)
...
* \[💻] [Introduction to Deep Learning with PyTorch](https://www.datacamp.com/courses/deep-learning-with-pytorch)
* \[ ] [Deeplizard: Neural Network Programming — Deep Learning with PyTorch](https://www.youtube.com/playlist?list=PLZbbT5o\_s2xrfNyHZsM6ufI0iZENK9xgG)
* \[🅤]ꭏ [Intro to Deep Learning with PyTorch](https://www.udacity.com/course/deep-learning-pytorch--ud188)
* \[📺 ] [PyTorch Lightning 101](https://www.youtube.com/playlist?list=PLaMu-SDt\_RB5NUm67hU2pdE75j6KaIOv2)
* \[ ] [Training a classification model on MNIST with PyTorch](https://youtu.be/OMDn66kM9Qc?list=PLaMu-SDt\_RB5NUm67hU2pdE75j6KaIOv2)
* \[ ] [From PyTorch to PyTorch Lightning](https://youtu.be/DbESHcCoWbM?list=PLaMu-SDt\_RB5NUm67hU2pdE75j6KaIOv2)
...
* \[📺 ] [SimCLR with PyTorch Lightning](https://www.youtube.com/playlist?list=PLaMu-SDt\_RB4k8VXiB3hOdsn0Y3GoXo1k)
* \[📺 ] [PyTorch Performance Tuning Guide](https://youtu.be/9mS1fIYj1So) `26:41:00`
* \[📺 ] [Skin Cancer Detection with PyTorch](https://www.youtube.com/playlist?list=PLUH\_l3HbfEW0wP7ZOKUxmlnG6sntCQpHX)
* \[ ] [\[PART 1\] Skin Cancer Detection with PyTorch](https://www.youtube.com/watch?v=6LdS9n\_L7u4) `0:10:21`
...
* \[📺 ] [Learn with Lightning](https://www.pytorchlightning.ai/tutorials)
* \[📺 ] [PyTorch Tutorial — RNN & LSTM & GRU — Recurren Neural Nets](https://www.youtube.com/watch?v=0\_PgWWmauHk) `00:15:51`
* \[📺 ] [Pytorch Zero to All](https://www.youtube.com/playlist?list=PLlMkM4tgfjnJ3I-dbhO9JTw7gNty6o\_2m)
...
* \[📺 ] [Lightning Chat: How a Grandmaster Won a Kaggle Competition Using Pytorch Lightning](https://www.youtube.com/watch?app=desktop\&v=0HQCK\_l-njI)
* \[📺 ] [Production Inference Deployment with PyTorch](https://youtu.be/Dk88zv1KYMI)
* \[📺 ] [What is Automatic Differentiation?](https://www.youtube.com/watch?v=wG\_nF1awSSY)
* \[📺 ] [JAX: accelerated machine learning research via composable function transformations in Python](https://www.youtube.com/watch?v=BzuEGdGHKjc)
...
By [Bryan Guner](https://medium.com/@bryanguner) on [August 30, 2021](https://medium.com/p/3dd8f14814a1).

[Canonical link](https://medium.com/@bryanguner/everything-you-need-to-become-a-machine-learner-3dd8f14814a1)
